...
import AsyncStorage from '@react-native-async-storage/async-storage';
 ...
 export default function MyServicesSolicitaded(){
    ...
    useEffect(()=>{
      ...
      <View style={styles.container}>
          <View style={styles.header}>
                  <Text style={styles.headerTextBold}>MEUS SERVIÇOS ATUAIS</Text>
              </View>
              <Text>Aqui você pode ver seus serviços atuais</Text>
              ...
              <TouchableOpacity style={styles.detailsButtonLoad} onPress={() => loadBudgets()}>
               ...
               
                {
                  !service.length
                  ?
                    <Text style={{ padding: 20, fontWeight: 'bold' }}>você não tem nenhum serviço no momento :((</Text>
                  :
                    <Text></Text>
                }
