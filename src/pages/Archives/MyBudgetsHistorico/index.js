...
export default function MyBudgetsHistorico(){
    ...
    <View style={styles.container}>
        <View style={styles.header}>
                <Text style={styles.headerTextBold}>HISTÓRICO ORÇAMENTOS</Text>
            </View>
            <Text>Aqui você pode ver todos os seus orçamentos...</Text>
            <TouchableOpacity style={styles.detailsButton} onPress={() => loadBudgets()}>
                ...
                {!budget.length
                    ?
                    <Text style={{ padding: 20, fontWeight: 'bold' }}>Você não tem nenhum orçamento ainda, vai lá e realiza um :))</Text>
                    :
                    <Text></Text>
                }
            <FlatList
